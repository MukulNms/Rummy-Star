...
//        itemsTextSize, itemsTextAlignment, itemsHasOutline, itemsOutlineColor, itemsIconPosition, itemsIconSize, selectedItem;
...
//            EditorGUILayout.PropertyField(selectedItem, new GUIContent("selected Item"));
